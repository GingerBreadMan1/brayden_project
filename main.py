                        ...
                        if l.upper() == "THE TOWN":
                            ...
                            if d.upper() == "BRING HER":
                                ...
                                if y.upper() == "YES":
                                    ...
                                    food = input("You go into the kitchen, and see what you have to work with, she has a fully stocked kitchen.\nWhat should you make?(ENTER ANY FOOD)")
                                    print(f"You start to make the {food} and when its done, you bring her a plate.\nKate:Thank you, it looks amazing.\nYou both begin to eat and when you finish, she smiles.\nKate:You definitely earned your stay here, theres a spare room upstairs, feel free to go rest whenever you feel like it.\nYou:Thank you.\nYou head up to the room and {k} follows you.\nYou enter the room, and smile seeing a nice bed waiting for you.\nYou lay on the bed and sigh, you finally feel at ease, you fall asleep finally safe.")
                                    print("Thats the game, good job!\nFeel free to play it again, there are many more endings, some good some bad.\nBut if you're done, then have a good one.\nGAME OVER")
                                    
                                elif y.upper() == "NO":
                                    print(f"You:I think all look elsewhere, but thank you.\nWoman:Ok, if you change your mind, I live over there.\nShe points to a house, you nod and decide to go check out the smoke you saw earlier.\nYou head back into the forrest and go toward the smoke, you hear some voices as you approach.\nYou crouch down and look from behind a tree.\nYou see the Director and a group of armed guards, they are talking to a few campers\nDirector:Have you seen a person run by here, they had a dog like creature with them.\nMan:No, can't say I have.\nIf you had gone here first, they might've ratted on you, or turn you over themselves.\nDirector:Do you know where they might have gone?\nMan:Our town is not far from here, you could check there.\nThe Director nods and starts to head back to the road where her car was.\nYou move sightly and she notices this.\nDirector:Whos there?")
                                    what = input("What do you do, run or talk?")
                                    if what.upper() == "RUN":
                                        print(f"You start to sprint away from them and you hear her shout.\nDirector:Catch them, don't kill them!\nYou hear the armed guards chase you, they are gaining ground quickly.\nYou make sharp turns between trees and try to lose them, but they stay on your tail.\nYou hear a shot fired and you feel a sharp pain in your leg, you fall to the ground and hit your head, knocking you out.\nYou wake up back in the bed you started this nightmare in, the Director is standing at your door.\nDirector:You were never going to get away, and I think you know that.\nYou:I'll find a way.\nDirector:Sure you will, this is your new home, get used to it.\nShe leaves and shuts the door, locking it behind her.")
                                        print("Thats the game, back where you started.\nSucks but that's life, there are many other endings, good ones and bad ones.\nBut if your done, then have a good one.\nGAME OVER")
                                    elif what.upper() == "TALK":
                                        print(f"You:I'm not coming with you.\nDirector:Oh but you are coming with me, my precious sibling.\nA chill runs down your spine at her words.\nYou:Excuse me?\nThe Director smiles and begins to walk towards the sound of your voice.\nDirector:Did you not recognize me? I'm hurt, was I really that forgetable?\nYour thoughts race, you remember that you had a sister, but she died, right?\nDirector:Oh I remember now, you were told I had died, I just got a new job, and now, you're importnat to my job.\nYou:So you would kill your sibling if it ment it helped you get a better control over your job?\nDirector:I'm not going to kill you, unless you make this difficult, I just need your blood.\nShe is right behind the tree that you are leaning against.\nDirector:So make this easy and just come with me, no bloodshed is needed here.\nThe man from the camp chimes in.\nMan:I don't know whats going on here, but it seems kinda messed up.\nThe Director, or rather your sister Sarah, snapped her fingers and the armed guards fire on the camp, killing the campers.\nSarah:Now come out, or their blood won't be the only one spilled.\nYou stand up and lift your hands up in the air.\nSarah:Good, follow me.\nShe takes you to her car and puts you inside it.\nYou see them put {k} into a cage and into the back of the car.\nYou tried, and failed, you knew deep down that you weren't going to make it, looks like you were right.")
                                        print("Thats the end, kinda depressing, but cool twist.\nYou can play again and see if you get a different ending, I probably made to many for this.\nBut if you're done, then have a good one.\nGAME OVER")
                            elif d.upper() == "LEAVE HER FOR NOW":
                                print(f"{k}, I'm gonna need you to stay here ok?\n{k} tilts her head and sits down, she whimpers a bit.\nYou pet her and go into the town, no one really notices you.\nYou look around and see a hotel, though, you don't really have money to pay for it.\nYou think to yourself; How am I going to get some money?\nYou look at the ground and in the corner of your eye, you see a 20 dollar bill stuck in between a rock and the road.\nYou pick it up and smile, you might be able to get a room now, but there is still one problem, how are you going to explain {k}?\nYou sit on the curb and think, you could cover her, no to suspicious, you could just walk in with her, but they'd probably call the police after seeing her.\nAs you sit and think, a German Sheaperd approaches you and sits in front of you.\nYou look at it and pet it, unexpectedly, it chirps.\nYou:{k}?\nThe dog wags its tail and chirps again.\nYou:You can shape shift?!\nYou smile, not needing to worry about her looks now, you go to the hotel\nYou walk in and approach the front desk\nYou:Hello, I would like one room please.\nThe man at the front nods.\nMan:That will be 15 dollars.\nYou hand him the 20 and he gives you your change and key.\nMan:Your room is room 210.\nYou head to your room and open the door, its fairly nice and had a decent bed.\nYou lay on the bed and fall asleep, finally able to relax, if just for a short while.")
